...
def voc2yolo(path):
    ...
    for file in os.listdir(path):
        ...
        out_file = open(path.replace('Annotations', 'changelabels') + file.replace('xml', 'txt'), 'w')
        # print(label_file)
...
if __name__ == '__main__':
	# 这里要改成自己数据集路径的格式
    path = '/Users/stl/Downloads/BLST/YoloV5_Project/Dataset/VOCdevkit/VOC2007/Annotations/'
    voc2yolo(path)
